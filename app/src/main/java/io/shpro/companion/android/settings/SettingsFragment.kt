...
import io.shpro.companion.android.authenticator.Authenticator
import io.shpro.companion.android.common.R as commonR
import io.shpro.companion.android.database.server.Server
import io.shpro.companion.android.nfc.NfcSetupActivity
import io.shpro.companion.android.onboarding.OnboardApp
import io.shpro.companion.android.settings.controls.ManageControlsSettingsFragment
import io.shpro.companion.android.settings.developer.DeveloperSettingsFragment
import io.shpro.companion.android.settings.language.LanguagesProvider
import io.shpro.companion.android.settings.notification.NotificationChannelFragment
import io.shpro.companion.android.settings.notification.NotificationHistoryFragment
import io.shpro.companion.android.settings.qs.ManageTilesFragment
import io.shpro.companion.android.settings.sensor.SensorSettingsFragment
import io.shpro.companion.android.settings.sensor.SensorUpdateFrequencyFragment
import io.shpro.companion.android.settings.server.ServerSettingsFragment
import io.shpro.companion.android.settings.shortcuts.ManageShortcutsSettingsFragment
import io.shpro.companion.android.settings.vehicle.ManageAndroidAutoSettingsFragment
import io.shpro.companion.android.settings.wear.SettingsWearActivity
import io.shpro.companion.android.settings.wear.SettingsWearDetection
import io.shpro.companion.android.settings.widgets.ManageWidgetsSettingsFragment
import io.shpro.companion.android.webview.WebViewActivity
