package io.shpro.companion.android.settings.shortcuts
...
import io.shpro.companion.android.database.IconDialogCompat
import io.shpro.companion.android.util.icondialog.getIconByMdiName
import io.shpro.companion.android.util.icondialog.mdiName
import io.shpro.companion.android.webview.WebViewActivity
import io.shpro.companion.android.widgets.assist.AssistShortcutActivity
        ...
        val shortcut = ShortcutInfo.Builder(app, shortcutId)
            ...
            .setIcon(
                if (icon != null) {
                    ...
                    Icon.createWithResource(app, R.drawable.ic_stat_ic_notification)
                }
            )
            .setIntent(intent)
            .build()
