package io.shpro.companion.android.database
...
import io.shpro.companion.android.common.util.CHANNEL_DATABASE
import io.shpro.companion.android.database.authentication.Authentication
import io.shpro.companion.android.database.authentication.AuthenticationDao
import io.shpro.companion.android.database.location.LocationHistoryDao
import io.shpro.companion.android.database.location.LocationHistoryItem
import io.shpro.companion.android.database.notification.NotificationDao
import io.shpro.companion.android.database.notification.NotificationItem
import io.shpro.companion.android.database.qs.TileDao
import io.shpro.companion.android.database.qs.TileEntity
import io.shpro.companion.android.database.sensor.Attribute
import io.shpro.companion.android.database.sensor.EntriesTypeConverter
import io.shpro.companion.android.database.sensor.Sensor
import io.shpro.companion.android.database.sensor.SensorDao
import io.shpro.companion.android.database.sensor.SensorSetting
import io.shpro.companion.android.database.sensor.SensorSettingTypeConverter
import io.shpro.companion.android.database.server.Server
import io.shpro.companion.android.database.server.ServerDao
import io.shpro.companion.android.database.settings.LocalNotificationSettingConverter
import io.shpro.companion.android.database.settings.LocalSensorSettingConverter
import io.shpro.companion.android.database.settings.Setting
import io.shpro.companion.android.database.settings.SettingsDao
import io.shpro.companion.android.database.wear.CameraTile
import io.shpro.companion.android.database.wear.CameraTileDao
import io.shpro.companion.android.database.wear.EntityStateComplications
import io.shpro.companion.android.database.wear.EntityStateComplicationsDao
import io.shpro.companion.android.database.wear.FavoriteCaches
import io.shpro.companion.android.database.wear.FavoriteCachesDao
import io.shpro.companion.android.database.wear.Favorites
import io.shpro.companion.android.database.wear.FavoritesDao
import io.shpro.companion.android.database.widget.ButtonWidgetDao
import io.shpro.companion.android.database.widget.ButtonWidgetEntity
import io.shpro.companion.android.database.widget.CameraWidgetDao
import io.shpro.companion.android.database.widget.CameraWidgetEntity
import io.shpro.companion.android.database.widget.MediaPlayerControlsWidgetDao
import io.shpro.companion.android.database.widget.MediaPlayerControlsWidgetEntity
import io.shpro.companion.android.database.widget.StaticWidgetDao
import io.shpro.companion.android.database.widget.StaticWidgetEntity
import io.shpro.companion.android.database.widget.TemplateWidgetDao
import io.shpro.companion.android.database.widget.TemplateWidgetEntity
import io.shpro.companion.android.database.widget.WidgetBackgroundTypeConverter
import io.shpro.companion.android.database.widget.WidgetTapActionConverter
        ...
        private fun notifyMigrationFailed() {
            ...
            runBlocking {
                try {
                    ...
                    Log.d(TAG, "Event sent to SH Pro")
                } catch (e: Exception) {
                    Log.e(TAG, "Unable to send event to SH Pro", e)
